...
public class operations{
    ...
    public void createStudent(Student st) {
       ...
       String query="insert into info(name,course,fee_paid)values(?,?,?)";
       try{
           PreparedStatement pstm=con.prepareStatement(query);
//           pstm.setInt(1,st.get_id());
           pstm.setString(1,st.get_name());
           pstm.setString(2,st.get_course());
           pstm.setDouble(3,st.get_fee_paid());
